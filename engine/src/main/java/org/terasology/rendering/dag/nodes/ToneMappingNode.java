...
public class ToneMappingNode extends AbstractNode {
    ...
    private FBO sceneToneMapped; // TODO: will be updated by frameBuffersManager
    private FBO sceneOpaque;

    @Override
    public void initialise() {
        toneMapping = worldRenderer.getMaterial("engine:prog.hdr"); // TODO: rename shader to toneMapping)
        requireFBO(frameBuffersManager, SCENE_TONE_MAPPED_FBO, new FBOManager(1.0f, FBO.Type.HDR));
    }
